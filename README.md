    ...
    sh -c "`curl -fsSL https://raw.github.com/hchen1506/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.github.com/hchen1506/dotfiles/master/install.sh`" -s ask
```
